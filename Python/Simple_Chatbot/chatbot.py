'''Adapted from https://github.com/Coding-Crashkurse/FastHTML-Basics/blob/main/llmapp.py'''
...
headers = [
    ...
    Link(rel="icon", href="pcst.png", type="image/png"),
...
def get():
    ...
    chat_history = Div(*[ChatMessage(msg)
                       for msg in messages], id="chat-history")

    return Html(
        *headers,
        H1("Chat with AI Pharmacist Zelda", cls="text-2xl"),
        Div(
            Img(src="pcst.png", cls="w-40 h-40 mx-auto"),
...
def chat(user_input: str):
    if user_input:
        ...
        response = llm.invoke(
            [SystemMessage(content="Respond like a pharmacist."), *messages]
        )
