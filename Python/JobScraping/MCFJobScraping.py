# This script serves to scrape websites daily from Mycareersfuture
'''

To obtain the API, Go to Inspect > Network, click through the various names and find the request URL under Headers
#But for MyCareersfuture seems like I'm lacking the credentials to obtain the data through an API call
